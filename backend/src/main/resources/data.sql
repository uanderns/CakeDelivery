...
insert into tb_avaliacao(classificacao,comentario) values (5, 'O bolo está maravilhoso!!! ');
...
insert into tb_cancelamento(motivo) values ('bolo chegou errado na entrega');
...
insert into tb_entregador (cpf,data_nascimento,genero,nome,telefone,doc_veiculo,email,senha) values ('13345678555', '1998-07-07', 'MASCULINO', 'Manoel Couves', '2197655332', 'KMB5057', 'manoel@couves.com', 'padrao2');
